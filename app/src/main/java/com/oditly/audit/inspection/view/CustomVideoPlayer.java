package com.oditly.audit.inspection.view;
...
public class CustomVideoPlayer extends LinearLayout {
    ...
    private MediaSource buildMediaStore(String mediaUrl) {
        ...
        defaultHttpDataSourceFactory.getDefaultRequestProperties().set("access-token", AppPreferences.INSTANCE.getAccessToken(context));
