...
public class DashboardFragment extends BaseFragment implements INetworkEvent {
    ...
    public void onNetworkCallCompleted(String type, String service, String response)
    {
        try {
            ...
            if (!object.getBoolean(AppConstant.RES_KEY_ERROR))
            {
                ...
                mTotalTV.setText(getString(R.string.text_passed)+" "+reportObj.optInt("passed_audit_count"));
