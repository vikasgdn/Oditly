package com.oditly.audit.inspection.photoeditor;
...
public class ColorPickerAdapter extends RecyclerView.Adapter<ColorPickerAdapter.ViewHolder> {
    ...
    public static List<Integer> getDefaultColors(Context context) {
        ...
        colorPickerColors.add(ContextCompat.getColor(context, R.color.c_dark_gray));
        ...
        colorPickerColors.add(ContextCompat.getColor(context, R.color.c_white));
