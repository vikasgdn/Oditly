...
public class AddAuditSignatureRequestForQuestion extends BaseStringRequest {

    //request params
    private static final String REQ_PARAM_AUDIT_ID = "audit_id";
    private static final String REQ_PARAM_QUESTION_ID = "question_id";
    private static final String REQ_PARAM_IS_FILE = "signature_image";
    ...
    public AddAuditSignatureRequestForQuestion(String accessToken, String url, String fileName, byte[] byteData, String auditId,String questionID, String firebaseToken, Context contaxt, Response.Listener<String> listener, Response.ErrorListener errorListener) {
