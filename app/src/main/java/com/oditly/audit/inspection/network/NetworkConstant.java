...
public class NetworkConstant
{
    ...
    public static final long TIMEOUT = 120;       // in second
    ...
    public static final String REQ_PARAM_OTP = "otp";
    public static final String REQ_PARAM_ACTION_PLAN_STS = "action_plan_status";
